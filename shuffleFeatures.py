...
result.to_csv('validation_shuffled.csv', encoding='utf-8', index=False, header=None)
...
result.to_csv('training_shuffled.csv', encoding='utf-8', index=False, header=None)
...
result.to_csv('test_shuffled.csv', encoding='utf-8', index=False, header=None)
'''
